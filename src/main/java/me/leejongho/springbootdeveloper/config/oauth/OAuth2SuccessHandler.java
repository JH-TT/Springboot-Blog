package me.leejongho.springbootdeveloper.config.oauth;
...
import me.leejongho.springbootdeveloper.util.CookieUtil;
...
public class OAuth2SuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    // 생성된 리프레시 토큰을 쿠키에 저장 (액세스 토큰이 만료되면 재발급 요청하기 위함)
